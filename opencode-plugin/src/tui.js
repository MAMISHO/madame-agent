...
exports.tui = void 0;
var tui = function (api, _options, _meta) { return __awaiter(void 0, void 0, void 0, function () {
    return __generator(this, function (_a) {
        ...
        api.command.register(function () { return [
            {
                ...
                onSelect: function () { return __awaiter(void 0, void 0, void 0, function () {
                    var response, data, error_1;
                    return __generator(this, function (_a) {
                        switch (_a.label) {
                            case 0:
                                _a.trys.push([0, 3, , 4]);
                                return [4 /*yield*/, fetch("http://localhost:3001/v1/Costs")];
                            case 1:
                                response = _a.sent();
        ...
        api.slots.register({
            slots: {
                sidebar_content: function () { return null; },
            },
        });
        return [2 /*return*/];
    });
